...
#5.поменять четные позиции в первом масиве на значениянечетных позиций из 2 массива
...
def get_list_10_odd_value_task01_v3(max_count=10):
    arr_odd = []
...
if __name__ == '__main__':
    print(get_list_odd_value_task01_v4(20))